...
public static class CleanUIRedesignToolV3
{
    ...
    private static void BuildDock(RectTransform root, BuildMenuUI buildMenu)
    {
        ...
        for (int i = 0; i < buildMenu.towerButtons.Length; i++)
        {
            ...
            Place(icon.rectTransform, new Vector2(0, -30), new Vector2(92, 54), new Vector2(.5f, 1));
            ...
            Place(name.rectTransform, new Vector2(0, -89), new Vector2(105, 28), new Vector2(.5f, 1));
            ...
            Place(cost.rectTransform, new Vector2(0, -119), new Vector2(100, 24), new Vector2(.5f, 1));
    ...
    private static void BuildUpgrade(RectTransform root, TowerUpgradeUI upgrade)
    {
        ...
        Place(title.rectTransform, new Vector2(28, -22), new Vector2(310, 44), new Vector2(0, 1));
        title.fontStyle = FontStyles.Bold;
        upgrade.towerNameText = title;

        Button close = ButtonEl("CloseButton", panel, "X", Panel2, Border);
        Place(close.GetComponent<RectTransform>(), new Vector2(-18, -18), new Vector2(42, 42), new Vector2(1, 1));
        ...
        Place(level.rectTransform, new Vector2(28, -70), new Vector2(250, 30), new Vector2(0, 1));
        upgrade.levelText = level;

        RectTransform current = Section(panel, "CurrentStats", new Vector2(18, -116), "CURRENT STATS");
        upgrade.strengthText = StatRow(current, "Damage", 50, "D");
        upgrade.attackSpeedText = StatRow(current, "Attack Speed", 91, "S");
        upgrade.rangeText = StatRow(current, "Range", 132, "R");
        ...
        upgrade.nextStrengthText = StatRow(next, "Damage", 50, "D");
        upgrade.nextAttackSpeedText = StatRow(next, "Attack Speed", 91, "S");
        upgrade.nextRangeText = StatRow(next, "Range", 132, "R");
        ...
        Place(cost.rectTransform, new Vector2(190, -18), new Vector2(182, 40), new Vector2(0, 1));
        upgrade.upgradeCostText = cost;

        Button up = ButtonEl("UpgradeButton", panel, "UPGRADE", CyanDim, Cyan);
        Place(up.GetComponent<RectTransform>(), new Vector2(18, -590), new Vector2(170, 56), new Vector2(0, 1));
        ...
        Place(sell.GetComponent<RectTransform>(), new Vector2(198, -590), new Vector2(120, 56), new Vector2(0, 1));
        ...
        Place(closeBottom.GetComponent<RectTransform>(), new Vector2(328, -590), new Vector2(86, 56), new Vector2(0, 1));
    ...
    {
        TMP_Text icon = TextEl(label + "Icon", parent, glyph, 16, Cyan, TextAlignmentOptions.Center);
    ...
    private static Button ButtonEl(string name, Transform parent, string text, Color bg, Color border)
    {
        ...
        colors.pressedColor = new Color(.65f, .88f, .94f, 1f);
        colors.disabledColor = new Color(.42f, .46f, .48f, .65f);
