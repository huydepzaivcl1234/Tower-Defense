...
/// <summary>
/// World relic reward pickup shown as a 3D card. No click is required: moving the mouse over it
/// collects it, queues a relic reward, then removes the world object.
/// </summary>
[RequireComponent(typeof(SphereCollider))]
public class RelicWorldCardPickup : MonoBehaviour
{
