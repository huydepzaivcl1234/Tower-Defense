...
public class RelicModifier
{
    ...
    [Tooltip("Fifth customizable value used by advanced effects such as Cannon Hero distance-per-step.")]
...
/// <summary>
/// One permanent-for-this-run roguelite buff. All tuning stays in data.
/// </summary>
