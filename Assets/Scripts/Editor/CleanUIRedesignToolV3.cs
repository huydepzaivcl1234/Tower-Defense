...
public static class CleanUIRedesignToolV3
{
    ...
    {
        // Legacy menu now routes to the non-destructive upgrade path.
        // Never rebuild hierarchy, replace Button references or overwrite designer sprites/icons.
        return AuroraSafeUIUpgradeTool.RepairAndUpgradeGameplay(showDialog);
    }
